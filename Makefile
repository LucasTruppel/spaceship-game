...
_SRC_DEPS = window.h game.h window.h spaceship.h enemy_spaceship.h game_handler.h player_spaceship.h shot.h keyboard_handler.h
...
_SRC_OBJ = main.o window.o game.o spaceship.o enemy_spaceship.o game_handler.o player_spaceship.o shot.o keyboard_handler.o
